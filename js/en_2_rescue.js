                ...
                for(let k=0;k<les;k++){
                    ...
                    <li>
                        ...
                        <article class="pop-txt2">
                            <h3>${titA}</h3>
                            <p>
                                <b>Rescued animal</b><br> ${pNameA}<br>
                                <b>Place</b><br> ${pPlaceA}<br>
                                <b>Rescue Procedure</b><br>${pDetailA}<br>
                            </p><br>
                            <h3>${titB}</h3>
                            <p>
                            <b>Rescued animal</b><br> ${pNameB}<br>
                            <b>Place</b><br> ${pPlaceB}<br>
                            <b>Rescue Procedure</b><br>${pDetailB}<br>
                            </p>
                        </article>
                        </li>
                        `
